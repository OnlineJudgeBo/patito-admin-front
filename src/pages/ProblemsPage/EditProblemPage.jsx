...
const EditForm = () => {
    const token = "TU_TOKEN_DE_AUTORIZACIÓN";
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const data = await apiService.fetchProblemById(problemId, token);
                let topicClassificationList = await apiService.fetchTopicList(token);
